			...
			<section>
				<div class="coluna col5 sidebar">
					...
					<ul class="sem-padding sem-marcador">
						<li>Rua Divino João de Oliveira, 196</li>
						<li>Bairro Jardim Panorâmico</li>
						<li>Patos de Minas - MG</li>
					</ul>
					<h3>Contato Direto</h3>
					<ul class="sem-padding sem-marcador">
						<li>Fone: <strong>(34) 9686-1802</strong></li>
						<li>Email: <strong>gabroc9@hotmail.com</strong></li>
						<li>Skype: <strong>gabroc</strong></li>
					</ul>
				</div>
